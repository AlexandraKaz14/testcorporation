...
@section('content_header')
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 ">
                {{Breadcrumbs::render("{$currentUserRole}.tests.results.edit", $result)}}
            </div>
        </div>
    </div>
@stop
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> {{__('common.edit result')}}</h3>
                        </div>
                        <div class="card-body">
                                            ...
                                            <div class="card-header">
                                                <h4 class="card-title w-100">
                                                    <a class="d-block w-100" data-toggle="collapse" href="#collapseThree">
                                                        {{__('common.rules for creating a result')}}
                                                    </a>
                                                </h4>
                                            </div>
                                ...
                                @else
                                    <div class="card-body">
                                        <div class="alert alert-warning alert-dismissible">
                                            <h5><i class="icon fas fa-exclamation-triangle"></i> {{__('common.Attention!')}}</h5>
                                            {{__('common.there are no variables')}}
                            ...
                            <form id="form-group" action="{{route("{$currentUserRole}.tests.results.update", $result->id)}}" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control" name="condition"
                                                  ...
                                                  placeholder="{{__('common.enter a conditional expression')}}">{{old('condition')}} {{$result->condition}}</textarea>
                                    </div>
                                        @include('partial.cropper', [
                                        'inputLabel' => __('common.picture'),
                                        'chooseFileLabel' => __('common.choose file'),
                                        'currentPicturePath' => $result->picture,
                                        'name' => 'picture',
                                        'finalWidth' => 800,
                                        'finalHeight' => 800,
                                        ])
                                    <div class="form-group">
                                        <label for="exampleInputDescription">{{__('common.text')}}</label>
                                        <textarea style="height: 200px;" type="text" class="form-control" name="text"
                                                  id="exampleInputDescription"
                                                  placeholder="{{__('common.enter result text')}}">{{$result->text}}</textarea>
                                    </div>
                                    @else

...
@section('content_header')
    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>{{__('common.variables')}}</h1>
            </div>
            <div class="col-sm-6 ">
                {{Breadcrumbs::render("{$currentUserRole}.tests.variables.create", $variable->test)}}
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> {{__('common.create variable')}}</h3>
                        </div>
                        <div class="card-body">
                            <form id="form-variable" action="{{route("{$currentUserRole}.tests.variables.store")}}" method="post">
                                @csrf
                                <input type="hidden" name="test_id" value="{{ $variable->test->id }}">
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="any" class="form-control" id="exampleInputValue" name="start_value" value="{{old('start_value')}}"

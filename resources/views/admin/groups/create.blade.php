                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> {{__('common.create group')}}</h3>
                        </div>
                        <div class="card-body">
                            <form id="form-group" action="{{route('admin.groups.store')}}" method="post"
                    ...
                    <button type="button" id="generate-slug"
                            class="btn btn-success btn-flat">{{__('common.create slug')}}</button>
                  </span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="test">{{__('common.select tests')}}</label>

                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> {{__('common.edit user')}}</h3>
                        </div>
                        <div class="card-body">

                            <form id="form-user" action="{{route('admin.users.update', $user->id)}}" method="post">
                                @csrf
                                @method('patch')
                                <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                        <label for="id_label_single">{{__('common.status')}}</label>

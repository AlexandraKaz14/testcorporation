    ...
    <div class="container-login100">
        ...
        <div class="wrap-login100">
            <div class="login100-pic">
                <img src="/images/logo.webp" class="rounded-circle" alt="logo" loading="lazy">
            </div>
            <div class="login100-form">

                <form action="{{ $password_email_url }}" method="post" class=" validate-form">
                    @csrf
                    ...
                    @if(session('status'))
                        <div class="link_sent text-center">
                            {{ session('status') }}
                        </div>
                    @endif
                ...
                <div class="text-center pt-4">
                        <a class="txt2" href="{{ $login_url }}">
                            <i class="fa fa-long-arrow-left m-l-5" aria-hidden="true"></i>
                            {{ __('adminlte::adminlte.Go back') }}
                        </a>
                </div>
            </div>
        </div>
